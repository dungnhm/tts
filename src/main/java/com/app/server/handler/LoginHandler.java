...
//                            Jedis jedis = new Jedis("localhost");
                            ...
                            avalue.put("id", session.id());
                            avalue.put("email", session.get("email"));
                            jedis.hmset(email, avalue);
                            jedis.set("id", session.id());
                            jedis.set("email", session.get("email"));
                            System.out.println("test store session id " + jedis.get("id"));
                            System.out.println("store sessin email: " + jedis.hgetAll(email).get("id"));
