 ...
 */
package com.app.dashchat.server;

import com.app.dashchat.server.vertical.DashchatVertical;
 ...
 * @author hungdt
 */
public class OrderServer implements Runnable, LoggerInterface {
    ...
    private DashchatVertical vertxVertical;
    ...
    public void setVertxVertical(DashchatVertical vertxVertical) {
